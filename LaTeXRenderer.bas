        ...
        If Not IsEmpty(cell.value) And IsText(cell.value) Then
            ...
            Do While InStr(txt, "$") > 0
                ...
                Do While InStr(startPos + 1, txt, "\$") > 0
                    Dim replaceEsc As Long: replaceEsc = InStr(startPos + 1, txt, "\$")
                ...
                With cell
                    ...
                    .Characters(startPos + Len(rendered), endPos).text = ""
...
NextLoop:
            ...
            txt = cell.value
            Do While InStr(txt, "æ") > 0 Or InStr(txt, "ç") > 0
                Dim escPos As Long: escPos = InStr(txt, "æ")
                If escPos > 0 Then
                    cell.Characters(escPos, 1).text = "$"
                    txt = cell.value
                End If
                escPos = InStr(txt, "ç")
                If escPos > 0 Then
